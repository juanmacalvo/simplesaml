 ...
 */
 $metadata['http://auth.saml.net'] = array (
   'SingleLogoutService' =>
   array (
     0 =>
     array (
       'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
       'Location' => 'http://localhost/simplesp/module.php/saml/sp/saml2-logout.php/moodle',
     ),
   ),
   ...
   array (
     ...
     array (
       ...
       'Location' => 'http://localhost/simplesp/module.php/saml/sp/saml2-acs.php/moodle',
     ),
     1 =>
     array (
       'index' => 1,
       'Binding' => 'urn:oasis:names:tc:SAML:1.0:profiles:browser-post',
       'Location' => 'http://localhost/simplesp/module.php/saml/sp/saml1-acs.php/moodle',
     ),
     2 =>
     array (
       'index' => 2,
     ...
     array (
       ...
       'Location' => 'http://localhost/simplesp/module.php/saml/sp/saml1-acs.php/moodle/artifact',
     ),
   ),
 );
